...
﻿using Windows.Foundation;
    ...
    /// by a WinRTXamlToolkit.Controls.GridSplitter control.
    /// </summary>
    public enum GridResizeBehavior
    {
        ...
        BasedOnAlignment = 0,
        /// <summary>
        /// For a horizontal WinRTXamlToolkit.Controls.GridSplitter, space is redistributed
        /// between the row that is specified for the WinRTXamlToolkit.Controls.GridSplitter
        /// and the next row that is below it. For a vertical WinRTXamlToolkit.Controls.GridSplitter,
        /// space is redistributed between the column that is specified for the WinRTXamlToolkit.Controls.GridSplitter
        ...
        /// For a horizontal WinRTXamlToolkit.Controls.GridSplitter, space is redistributed
        /// between the row that is specified for the WinRTXamlToolkit.Controls.GridSplitter
        /// and the next row that is above it. For a vertical WinRTXamlToolkit.Controls.GridSplitter,
        /// space is redistributed between the column that is specified for the WinRTXamlToolkit.Controls.GridSplitter
        ...
        /// WinRTXamlToolkit.Controls.GridSplitter. For a vertical WinRTXamlToolkit.Controls.GridSplitter,
        /// space is redistributed between the columns that are to the left and right
        /// of the column that is specified for the WinRTXamlToolkit.Controls.GridSplitter.
        /// </summary>
        PreviousAndNext = 3,
    }

    /// <summary>
    /// Specifies whether a WinRTXamlToolkit.Controls.GridSplitter control redistributes
    ...
    public enum GridResizeDirection
    {
        ...
        /// and Windows.UI.Xaml.FrameworkElement.ActualHeight properties of the WinRTXamlToolkit.Controls.GridSplitter.
        /// </summary>
        Auto = 0,
        /// <summary>
    ...
    public class GridSplitter : Control
    {
        ...
        private GridSplitter _previewGridSplitter;
        ...
        /// indicates whether the GridSplitter control resizes rows or columns.
        /// </summary>
        ...
        private Grid GetGrid()
        {
            ...
            if (grid == null)
            {
                throw new InvalidOperationException(
                    "GridSplitter only works when hosted in a Grid.");
            }
            return grid;
        }
        #endregion
    ...
    /// <summary>
    /// A primitive control used for representing a preview of the manipulated GridSplitter
    /// </summary>
